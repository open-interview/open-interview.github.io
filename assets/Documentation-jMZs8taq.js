import{r as p,j as e,X as G,at as C,w as R,Q as T,C as A,S as B,Z as y,o as Q}from"./index-DYXbnNTj.js";import{I as L}from"./InteractiveDiagram-7sU28o_j.js";import{A as F,L as v,C as j}from"./AppLayout-D38Wyc0D.js";import{S as O}from"./SEOHead-B_5Q2btc.js";import{M as U}from"./menu-DPjczhvS.js";import{B as H}from"./user-CTVaQfA_.js";import{B as w}from"./brain-gLE3Jh6Z.js";import{D as f,S as N,C as V}from"./server-BVMaMUj1.js";import{P as S}from"./zoom-out-BFixQOmG.js";import{G as k}from"./globe-Cftr54lf.js";import{G as _}from"./UnifiedSearch-BVLavurR.js";import{E as M}from"./external-link-C6BgAQE4.js";import{C as z}from"./chevron-left-po2_TZMt.js";import{S as I}from"./shield-DKrPdIPo.js";import{F as q}from"./file-code-DpEqCGBC.js";import{B as D}from"./box-C9cCrBcf.js";import{C as K}from"./chevron-down-FTetxXIT.js";import{C as $}from"./copy-BkP-Drri.js";import"./rotate-ccw-BF7mnbJV.js";import"./sun-CmJ-keH_.js";import"./arrow-right-GxNPROBC.js";import"./loader-circle-BpBVa99C.js";const g=[{id:"overview",title:"Architecture Overview",icon:v,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:w,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:f,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:j,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:S,color:"#f778ba"},{id:"api",title:"API Reference",icon:N,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:k,color:"#d29922"}];function Se(){const[s,i]=p.useState("overview"),[t,a]=p.useState(!1),[c,b]=p.useState("");return p.useEffect(()=>{a(!1)},[s]),e.jsxs(F,{fullWidth:!0,children:[e.jsx(O,{title:"Documentation | Code Reels",description:"Technical documentation, architecture overview, AI pipeline, API reference, and deployment guides for Code Reels."}),e.jsxs("div",{className:"min-h-screen bg-background text-foreground pt-14 lg:pt-0 overflow-x-hidden",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>a(!t),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center",children:t?e.jsx(G,{className:"w-5 h-5"}):e.jsx(U,{className:"w-5 h-5"})}),e.jsx(C,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-3 hover:opacity-80 transition-opacity duration-150 ease-out cursor-pointer",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(H,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-foreground",children:"Documentation"}),e.jsx("div",{className:"text-xs text-muted-foreground",children:"Reel-LearnHub"})]})]})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:"hidden md:flex items-center gap-2 px-3 py-1.5 bg-[#21262d] rounded-lg border border-[#30363d]",children:[e.jsx(R,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("input",{type:"text",placeholder:"Search docs...",value:c,onChange:n=>b(n.target.value),className:"bg-transparent text-sm w-40 focus:w-56 transition-all outline-none placeholder:text-[#6e7681]"}),e.jsx("kbd",{className:"text-[10px] text-[#6e7681] bg-[#161b22] px-1.5 py-0.5 rounded border border-[#30363d]",children:"⌘K"})]}),e.jsx(C,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(T,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
