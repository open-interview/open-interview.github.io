import{r as p,j as e,X as G,at as C,w as R,Q as B,C as A,S as T,Z as y,o as L}from"./index-82H0nTwR.js";import{I as Q}from"./InteractiveDiagram-CIAyRu6N.js";import{A as F,L as v,C as j}from"./AppLayout-DWgi8YjR.js";import{S as U}from"./SEOHead-n9uxISvF.js";import{M as O}from"./menu-CZW4CLHx.js";import{B as _}from"./user-CCPsuPea.js";import{B as w}from"./brain-B2yzhjLW.js";import{D as f,S as N,C as H}from"./server-CFIo--Yk.js";import{P as S}from"./zoom-out-Bvupgu4P.js";import{G as k}from"./globe-skL3Jurl.js";import{G as V}from"./UnifiedSearch-Dpdesw_p.js";import{E as M}from"./external-link-NQXezuLe.js";import{C as z}from"./chevron-left-C9Eftpux.js";import{S as D}from"./shield-NAxkm8vK.js";import{F as q}from"./file-code-CuF-sxll.js";import{B as I}from"./box-BwYUrMCi.js";import{C as K}from"./chevron-down-CcElLGKN.js";import{C as $}from"./copy-8Z5lo_kH.js";import"./rotate-ccw-Uq1nzci5.js";import"./sun-BsF_bb6Y.js";import"./arrow-right-DnV4EKgv.js";import"./loader-circle-BuPHasHu.js";const g=[{id:"overview",title:"Architecture Overview",icon:v,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:w,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:f,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:j,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:S,color:"#f778ba"},{id:"api",title:"API Reference",icon:N,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:k,color:"#d29922"}];function Se(){const[s,i]=p.useState("overview"),[t,a]=p.useState(!1),[c,b]=p.useState("");return p.useEffect(()=>{a(!1)},[s]),e.jsxs(F,{fullWidth:!0,children:[e.jsx(U,{title:"Documentation | Code Reels",description:"Technical documentation, architecture overview, AI pipeline, API reference, and deployment guides for Code Reels."}),e.jsxs("div",{className:"min-h-screen bg-background text-foreground pt-14 lg:pt-0 overflow-x-hidden",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>a(!t),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center",children:t?e.jsx(G,{className:"w-5 h-5"}):e.jsx(O,{className:"w-5 h-5"})}),e.jsx(C,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-3 hover:opacity-80 transition-opacity duration-150 ease-out cursor-pointer",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(_,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-foreground",children:"Documentation"}),e.jsx("div",{className:"text-xs text-muted-foreground",children:"Reel-LearnHub"})]})]})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:"hidden md:flex items-center gap-2 px-3 py-1.5 bg-[#21262d] rounded-lg border border-[#30363d]",children:[e.jsx(R,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("input",{type:"text",placeholder:"Search docs...",value:c,onChange:n=>b(n.target.value),className:"bg-transparent text-sm w-40 focus:w-56 transition-all outline-none placeholder:text-[#6e7681]"}),e.jsx("kbd",{className:"text-[10px] text-[#6e7681] bg-[#161b22] px-1.5 py-0.5 rounded border border-[#30363d]",children:"⌘K"})]}),e.jsx(C,{href:"/",children:e.jsxs("a",{className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(B,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
        ...
        `,children:e.jsxs("nav",{className:"p-4 space-y-1 overflow-y-auto h-full",children:[e.jsx("div",{className:"text-xs font-semibold text-[#8b949e] uppercase tracking-wider px-3 mb-3",children:"Documentation"}),g.map(n=>{const u=n.icon,m=s===n.id;return e.jsxs("button",{onClick:()=>i(n.id),className:`
                  ...
                  `,children:[e.jsx("div",{className:`p-1.5 rounded-md transition-colors duration-150 ease-out ${m?"bg-[#7c3aed]/30":""}`,style:{color:m?"#7c3aed":void 0},children:e.jsx(u,{className:"w-4 h-4"})}),e.jsx("span",{className:"text-sm font-medium",children:n.title}),m&&e.jsx(A,{className:"w-4 h-4 ml-auto text-[#6e7681]"})]},n.id)}),e.jsxs("div",{className:"pt-6 mt-6 border-t border-[#21262d]",children:[e.jsx("div",{className:"text-xs font-semibold text-[#8b949e] uppercase tracking-wider px-3 mb-3",children:"Quick Links"}),e.jsxs("a",{href:"https://github.com",target:"_blank",rel:"noopener",className:"flex items-center gap-3 px-3 py-2 text-sm text-[#8b949e] hover:text-white rounded-lg hover:bg-[#161b22] transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(V,{className:"w-4 h-4"}),e.jsx("span",{children:"GitHub Repository"}),e.jsx(M,{className:"w-3 h-3 ml-auto"})]}),e.jsxs("a",{href:"/whats-new",className:"flex items-center gap-3 px-3 py-2 text-sm text-[#8b949e] hover:text-white rounded-lg hover:bg-[#161b22] transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(T,{className:"w-4 h-4"}),e.jsx("span",{children:"What's New"})]})]})]})}),t&&e.jsx("div",{className:"fixed inset-0 bg-black/50 z-30 lg:hidden",onClick:()=>a(!1)}),e.jsx("main",{className:"flex-1 min-w-0 px-4 lg:px-8 py-8 lg:py-12 pb-24",children:e.jsxs("div",{className:"max-w-4xl",children:[s==="overview"&&e.jsx(W,{}),s==="ai-pipeline"&&e.jsx(Y,{}),s==="database"&&e.jsx(J,{}),s==="frontend"&&e.jsx(Z,{}),s==="illustrations"&&e.jsx(X,{}),s==="api"&&e.jsx(ee,{}),s==="deployment"&&e.jsx(te,{}),(()=>{const n=g.findIndex(P=>P.id===s),u=g[n-1]??null,m=g[n+1]??null;return e.jsxs("div",{className:"flex justify-between mt-12 pt-6 border-t border-border",children:[u?e.jsxs("button",{onClick:()=>i(u.id),className:"flex items-center gap-2 px-4 py-2 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(z,{className:"w-4 h-4"}),u.title]}):e.jsx("div",{}),m?e.jsxs("button",{onClick:()=>i(m.id),className:"flex items-center gap-2 px-4 py-2 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[m.title,e.jsx(A,{className:"w-4 h-4"})]}):e.jsx("div",{})]})})()]})})]})]})]})}function h({icon:s,title:i,description:t,color:a="#58a6ff"}){return e.jsxs("div",{className:"mb-10",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-3",children:[e.jsx("div",{className:"p-3 rounded-xl",style:{backgroundColor:`${a}15`},children:e.jsx(s,{className:"w-7 h-7",style:{color:a}})}),e.jsx("div",{children:e.jsx("h1",{className:"text-2xl lg:text-3xl font-bold text-white",children:i})})]}),e.jsx("p",{className:"text-lg text-[#8b949e] leading-relaxed max-w-prose",children:t})]})}function r({code:s,language:i="typescript",title:t,copyable:a=!0}){const[c,b]=p.useState(!1),n=()=>{navigator.clipboard.writeText(s),b(!0),setTimeout(()=>b(!1),2e3)};return e.jsxs("div",{className:"rounded-xl overflow-hidden border border-[#30363d] my-6 group",children:[t&&e.jsxs("div",{className:"bg-[#161b22] px-4 py-2.5 border-b border-[#30363d] flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(q,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("span",{className:"text-sm text-[#8b949e] font-mono",children:t})]}),a&&e.jsx("button",{onClick:n,className:"p-1.5 hover:bg-[#30363d] rounded transition-colors duration-150 ease-out cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center",title:"Copy code",children:c?e.jsx(L,{className:"w-4 h-4 text-[#3fb950]"}):e.jsx($,{className:"w-4 h-4 text-[#6e7681]"})})]}),e.jsx("pre",{className:"bg-[#0d1117] p-4 overflow-x-auto",children:e.jsx("code",{className:`language-${i} text-sm text-[#e6edf3] font-mono leading-relaxed`,children:s.trim()})})]})}function d({title:s,description:i,diagram:t}){const[a,c]=p.useState(!0);return e.jsxs("div",{className:"rounded-xl border border-[#30363d] bg-[#161b22]/50 overflow-hidden my-8",children:[e.jsxs("button",{onClick:()=>c(!a),className:"w-full p-4 flex items-center justify-between hover:bg-[#21262d]/50 transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsxs("div",{className:"text-left",children:[e.jsxs("h3",{className:"font-semibold text-white flex items-center gap-2",children:[e.jsx(I,{className:"w-4 h-4 text-[#58a6ff]"}),s]}),e.jsx("p",{className:"text-sm text-[#8b949e] mt-1",children:i})]}),e.jsx(K,{className:`w-5 h-5 text-[#6e7681] transition-transform ${a?"rotate-180":""}`})]}),a&&e.jsx("div",{className:"p-4 pt-0 border-t border-[#30363d]/50",children:e.jsx("div",{className:"bg-[#0d1117] rounded-lg p-4 overflow-x-auto",children:e.jsx(Q,{chart:t})})})]})}function E({children:s}){return e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6",children:s})}function o({icon:s,title:i,description:t,color:a="#58a6ff"}){return e.jsxs("div",{className:"p-4 rounded-xl border border-[#30363d] bg-[#161b22]/30 hover:bg-[#161b22] hover:border-[#58a6ff]/30 transition-all duration-150 ease-out group",children:[e.jsx("div",{className:"p-2 rounded-lg w-fit mb-3",style:{backgroundColor:`${a}15`},children:e.jsx(s,{className:"w-5 h-5",style:{color:a}})}),e.jsx("h4",{className:"font-semibold text-white mb-1 group-hover:text-[#58a6ff] transition-colors duration-150 ease-out",children:i}),e.jsx("p",{className:"text-sm text-[#8b949e] leading-relaxed",children:t})]})}function x({type:s="info",title:i,children:t}){const c={info:{bg:"bg-[#58a6ff]/10",border:"border-[#58a6ff]/30",icon:"💡",color:"text-[#58a6ff]"},warning:{bg:"bg-[#d29922]/10",border:"border-[#d29922]/30",icon:"⚠️",color:"text-[#d29922]"},success:{bg:"bg-[#3fb950]/10",border:"border-[#3fb950]/30",icon:"✅",color:"text-[#3fb950]"},tip:{bg:"bg-[#a371f7]/10",border:"border-[#a371f7]/30",icon:"🎯",color:"text-[#a371f7]"}}[s];return e.jsxs("div",{className:`${c.bg} ${c.border} border rounded-xl p-4 my-6`,children:[e.jsxs("div",{className:`font-semibold ${c.color} mb-2 flex items-center gap-2`,children:[e.jsx("span",{children:c.icon})," ",i]}),e.jsx("div",{className:"text-sm text-[#8b949e] leading-relaxed max-w-prose",children:t})]})}function l(){return e.jsx("hr",{className:"border-[#21262d] my-10"})}function W(){return e.jsxs("div",{children:[e.jsx(h,{icon:v,title:"Architecture Overview",description:"A modern full-stack application built with React, Express, and AI-powered content generation using LangGraph pipelines.",color:"#58a6ff"}),e.jsx(d,{title:"System Architecture",description:"High-level overview of the main components and their interactions",diagram:`
graph TB
...
}`}),e.jsx(x,{type:"warning",title:"Production Checklist",children:"Before deploying to production, ensure you have: configured all required environment variables, run database migrations, set up Qdrant collection with proper indexes, and tested the AI pipeline with your API keys."})]})}export{Se as default};
