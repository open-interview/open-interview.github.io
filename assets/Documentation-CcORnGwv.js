import{r as u,j as e}from"./vendor-react-Ct_XtThl.js";import{b as P,A as B,af as C}from"./index-yqdOGLaX.js";import{InteractiveDiagram as R}from"./InteractiveDiagram-DWxltVsx.js";import{S as T}from"./SEOHead-Jwf-WeF0.js";import{X as L,D as Q,B as F,H as O,L as y,a as N,ak as b,b as j,P as w,a3 as S,af as k,l as A,x as U,E as _,S as H,k as V,Z as v,a0 as D,b7 as I,al as z,aQ as q,aq as M,K,am as $}from"./vendor-lucide-CUW1JFFJ.js";import"./vendor-radix-Dmoils4g.js";import"./vendor-recharts-Cjn_V97i.js";import"./vendor-framer-DWGaSOWf.js";const g=[{id:"overview",title:"Architecture Overview",icon:y,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:N,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:b,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:j,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:w,color:"#f778ba"},{id:"api",title:"API Reference",icon:S,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:k,color:"#d29922"}];function de(){const[,s]=P(),[i]=u.useState(()=>localStorage.getItem("admin_mode")==="true"),[t,a]=u.useState("overview"),[n,p]=u.useState(!1);return i?(u.useEffect(()=>{p(!1)},[t]),e.jsxs(B,{fullWidth:!0,children:[e.jsx(T,{title:"Documentation | Open Interview",description:"Technical documentation, architecture overview, AI pipeline, API reference, and deployment guides for Open Interview."}),e.jsxs("div",{className:"min-h-screen bg-background text-foreground pt-14 lg:pt-0 overflow-x-hidden",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>p(!n),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center",children:n?e.jsx(L,{className:"w-5 h-5"}):e.jsx(Q,{className:"w-5 h-5"})}),e.jsxs(C,{href:"/",className:"flex items-center gap-3 hover:opacity-80 transition-opacity duration-150 ease-out cursor-pointer",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(F,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-foreground",children:"Documentation"}),e.jsx("div",{className:"text-xs text-muted-foreground",children:"Open Interview"})]})]})]}),e.jsx("div",{className:"flex items-center gap-3",children:e.jsxs(C,{href:"/",className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(O,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
...
}`}),e.jsx(x,{type:"warning",title:"Production Checklist",children:"Before deploying to production, ensure you have: configured all required environment variables, run database migrations, set up Qdrant collection with proper indexes, and tested the AI pipeline with your API keys."})]})}export{de as default};
