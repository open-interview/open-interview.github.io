import{r as u,j as e}from"./vendor-radix-CF4JLO-s.js";import{u as P,e as B,X as R,ac as T,b2 as C,j as L,aa as Q,L as y,B as N,o as j,C as A,G as F,E as O,l as U,H as _,Z as v,r as H,p as V}from"./index-BGaJ_Nm8.js";import{InteractiveDiagram as z}from"./InteractiveDiagram-7OmU_o1T.js";import{S as M}from"./SEOHead-DsqWlYke.js";import{D as b,C as K}from"./database-DtklSB0j.js";import{P as w}from"./zoom-out-BWGzj30e.js";import{S}from"./server-Dl9NQ_iq.js";import{G as k}from"./globe-4iljFLWu.js";import{S as D}from"./shield-BJQagU5K.js";import{F as I}from"./file-code-DuBRq4if.js";import{B as q}from"./box-S5JF0sRV.js";import{C as $}from"./copy-BetgNwsz.js";import"./vendor-react-laobIIQM.js";import"./vendor-charts-C83DFpsY.js";import"./vendor-animation-Da6LD4u4.js";import"./triangle-alert-DQ_ITFgz.js";import"./rotate-ccw-BGIk_n3x.js";const g=[{id:"overview",title:"Architecture Overview",icon:y,color:"#58a6ff"},{id:"ai-pipeline",title:"AI Pipeline",icon:N,color:"#a371f7"},{id:"database",title:"Database & Storage",icon:b,color:"#3fb950"},{id:"frontend",title:"Frontend Patterns",icon:j,color:"#f78166"},{id:"illustrations",title:"Illustration System",icon:w,color:"#f778ba"},{id:"api",title:"API Reference",icon:S,color:"#39c5cf"},{id:"deployment",title:"Deployment",icon:k,color:"#d29922"}];function je(){const[,s]=P(),[i]=u.useState(()=>localStorage.getItem("admin_mode")==="true"),[t,a]=u.useState("overview"),[n,p]=u.useState(!1);return i?(u.useEffect(()=>{p(!1)},[t]),e.jsxs(B,{fullWidth:!0,children:[e.jsx(M,{title:"Documentation | Open Interview",description:"Technical documentation, architecture overview, AI pipeline, API reference, and deployment guides for Open Interview."}),e.jsxs("div",{className:"min-h-screen bg-background text-foreground pt-14 lg:pt-0 overflow-x-hidden",children:[e.jsx("header",{className:"sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-md",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 h-16 flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>p(!n),className:"lg:hidden p-2 hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center",children:n?e.jsx(R,{className:"w-5 h-5"}):e.jsx(T,{className:"w-5 h-5"})}),e.jsxs(C,{href:"/",className:"flex items-center gap-3 hover:opacity-80 transition-opacity duration-150 ease-out cursor-pointer",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-gradient-to-br from-[#58a6ff] to-[#a371f7] flex items-center justify-center",children:e.jsx(L,{className:"w-5 h-5 text-white"})}),e.jsxs("div",{className:"hidden sm:block",children:[e.jsx("div",{className:"font-semibold text-foreground",children:"Documentation"}),e.jsx("div",{className:"text-xs text-muted-foreground",children:"Open Interview"})]})]})]}),e.jsx("div",{className:"flex items-center gap-3",children:e.jsxs(C,{href:"/",className:"flex items-center gap-2 px-3 py-1.5 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(Q,{className:"w-4 h-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Back to App"})]})})]})}),e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsx("aside",{className:`
        ...
        `,children:e.jsxs("nav",{className:"p-4 space-y-1 overflow-y-auto h-full",children:[e.jsx("div",{className:"text-xs font-semibold text-[#8b949e] uppercase tracking-wider px-3 mb-3",children:"Documentation"}),g.map(c=>{const f=c.icon,m=t===c.id;return e.jsxs("button",{onClick:()=>a(c.id),className:`
                    ...
                    ${m?"bg-[#7c3aed]/20 text-white border border-[#7c3aed]/40":"text-[#8b949e] hover:text-white hover:bg-[#161b22] border border-transparent"}
                  `,children:[e.jsx("div",{className:`p-1.5 rounded-md transition-colors duration-150 ease-out ${m?"bg-[#7c3aed]/30":""}`,style:{color:m?"#7c3aed":void 0},children:e.jsx(f,{className:"w-4 h-4"})}),e.jsx("span",{className:"text-sm font-medium",children:c.title}),m&&e.jsx(A,{className:"w-4 h-4 ml-auto text-[#6e7681]"})]},c.id)}),e.jsxs("div",{className:"pt-6 mt-6 border-t border-[#21262d]",children:[e.jsx("div",{className:"text-xs font-semibold text-[#8b949e] uppercase tracking-wider px-3 mb-3",children:"Quick Links"}),e.jsxs("a",{href:"https://github.com",target:"_blank",rel:"noopener",className:"flex items-center gap-3 px-3 py-2 text-sm text-[#8b949e] hover:text-white rounded-lg hover:bg-[#161b22] transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(F,{className:"w-4 h-4"}),e.jsx("span",{children:"GitHub Repository"}),e.jsx(O,{className:"w-3 h-3 ml-auto"})]}),e.jsxs("a",{href:"/whats-new",className:"flex items-center gap-3 px-3 py-2 text-sm text-[#8b949e] hover:text-white rounded-lg hover:bg-[#161b22] transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(U,{className:"w-4 h-4"}),e.jsx("span",{children:"What's New"})]})]})]})}),n&&e.jsx("div",{className:"fixed inset-0 bg-black/50 z-30 lg:hidden",onClick:()=>p(!1)}),e.jsx("main",{className:"flex-1 min-w-0 px-4 lg:px-8 py-8 lg:py-12 pb-24",children:e.jsxs("div",{className:"max-w-4xl",children:[t==="overview"&&e.jsx(W,{}),t==="ai-pipeline"&&e.jsx(J,{}),t==="database"&&e.jsx(Y,{}),t==="frontend"&&e.jsx(Z,{}),t==="illustrations"&&e.jsx(X,{}),t==="api"&&e.jsx(ee,{}),t==="deployment"&&e.jsx(te,{}),(()=>{const c=g.findIndex(G=>G.id===t),f=g[c-1]??null,m=g[c+1]??null;return e.jsxs("div",{className:"flex justify-between mt-12 pt-6 border-t border-border",children:[f?e.jsxs("button",{onClick:()=>a(f.id),className:"flex items-center gap-2 px-4 py-2 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsx(_,{className:"w-4 h-4"}),f.title]}):e.jsx("div",{}),m?e.jsxs("button",{onClick:()=>a(m.id),className:"flex items-center gap-2 px-4 py-2 text-sm text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-lg transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[m.title,e.jsx(A,{className:"w-4 h-4"})]}):e.jsx("div",{})]})})()]})})]})]})]})):e.jsx("div",{className:"min-h-screen flex items-center justify-center",children:e.jsxs("div",{className:"text-center max-w-md px-6 py-12",children:[e.jsx("h1",{className:"text-2xl font-bold mb-2",children:"Access Restricted"}),e.jsx("p",{className:"text-muted-foreground mb-6",children:"This page is for internal documentation only."}),e.jsx("button",{onClick:()=>s("/"),className:"px-6 py-3 bg-primary text-primary-foreground rounded-xl font-bold",children:"Back to Home"})]})})}function h({icon:s,title:i,description:t,color:a="#58a6ff"}){return e.jsxs("div",{className:"mb-10",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-3",children:[e.jsx("div",{className:"p-3 rounded-xl",style:{backgroundColor:`${a}15`},children:e.jsx(s,{className:"w-7 h-7",style:{color:a}})}),e.jsx("div",{children:e.jsx("h1",{className:"text-2xl lg:text-3xl font-bold text-white",children:i})})]}),e.jsx("p",{className:"text-lg text-[#8b949e] leading-relaxed max-w-prose",children:t})]})}function r({code:s,language:i="typescript",title:t,copyable:a=!0}){const[n,p]=u.useState(!1),c=()=>{navigator.clipboard.writeText(s),p(!0),setTimeout(()=>p(!1),2e3)};return e.jsxs("div",{className:"rounded-xl overflow-hidden border border-[#30363d] my-6 group",children:[t&&e.jsxs("div",{className:"bg-[#161b22] px-4 py-2.5 border-b border-[#30363d] flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(I,{className:"w-4 h-4 text-[#8b949e]"}),e.jsx("span",{className:"text-sm text-[#8b949e] font-mono",children:t})]}),a&&e.jsx("button",{onClick:c,className:"p-1.5 hover:bg-[#30363d] rounded transition-colors duration-150 ease-out cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center",title:"Copy code",children:n?e.jsx(V,{className:"w-4 h-4 text-[#3fb950]"}):e.jsx($,{className:"w-4 h-4 text-[#6e7681]"})})]}),e.jsx("pre",{className:"bg-[#0d1117] p-4 overflow-x-auto",children:e.jsx("code",{className:`language-${i} text-sm text-[#e6edf3] font-mono leading-relaxed`,children:s.trim()})})]})}function d({title:s,description:i,diagram:t}){const[a,n]=u.useState(!0);return e.jsxs("div",{className:"rounded-xl border border-[#30363d] bg-[#161b22]/50 overflow-hidden my-8",children:[e.jsxs("button",{onClick:()=>n(!a),className:"w-full p-4 flex items-center justify-between hover:bg-[#21262d]/50 transition-colors duration-150 ease-out cursor-pointer min-h-[44px]",children:[e.jsxs("div",{className:"text-left",children:[e.jsxs("h3",{className:"font-semibold text-white flex items-center gap-2",children:[e.jsx(q,{className:"w-4 h-4 text-[#58a6ff]"}),s]}),e.jsx("p",{className:"text-sm text-[#8b949e] mt-1",children:i})]}),e.jsx(H,{className:`w-5 h-5 text-[#6e7681] transition-transform ${a?"rotate-180":""}`})]}),a&&e.jsx("div",{className:"p-4 pt-0 border-t border-[#30363d]/50",children:e.jsx("div",{className:"bg-[#0d1117] rounded-lg p-4 overflow-x-auto",children:e.jsx(z,{chart:t})})})]})}function E({children:s}){return e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6",children:s})}function o({icon:s,title:i,description:t,color:a="#58a6ff"}){return e.jsxs("div",{className:"p-4 rounded-xl border border-[#30363d] bg-[#161b22]/30 hover:bg-[#161b22] hover:border-[#58a6ff]/30 transition-all duration-150 ease-out group",children:[e.jsx("div",{className:"p-2 rounded-lg w-fit mb-3",style:{backgroundColor:`${a}15`},children:e.jsx(s,{className:"w-5 h-5",style:{color:a}})}),e.jsx("h4",{className:"font-semibold text-white mb-1 group-hover:text-[#58a6ff] transition-colors duration-150 ease-out",children:i}),e.jsx("p",{className:"text-sm text-[#8b949e] leading-relaxed",children:t})]})}function x({type:s="info",title:i,children:t}){const n={info:{bg:"bg-[#58a6ff]/10",border:"border-[#58a6ff]/30",icon:"💡",color:"text-[#58a6ff]"},warning:{bg:"bg-[#d29922]/10",border:"border-[#d29922]/30",icon:"⚠️",color:"text-[#d29922]"},success:{bg:"bg-[#3fb950]/10",border:"border-[#3fb950]/30",icon:"✅",color:"text-[#3fb950]"},tip:{bg:"bg-[#a371f7]/10",border:"border-[#a371f7]/30",icon:"🎯",color:"text-[#a371f7]"}}[s];return e.jsxs("div",{className:`${n.bg} ${n.border} border rounded-xl p-4 my-6`,children:[e.jsxs("div",{className:`font-semibold ${n.color} mb-2 flex items-center gap-2`,children:[e.jsx("span",{children:n.icon})," ",i]}),e.jsx("div",{className:"text-sm text-[#8b949e] leading-relaxed max-w-prose",children:t})]})}function l(){return e.jsx("hr",{className:"border-[#21262d] my-10"})}function W(){return e.jsxs("div",{children:[e.jsx(h,{icon:y,title:"Architecture Overview",description:"A modern full-stack application built with React, Express, and AI-powered content generation using LangGraph pipelines.",color:"#58a6ff"}),e.jsx(d,{title:"System Architecture",description:"High-level overview of the main components and their interactions",diagram:`
graph TB
...
`}),e.jsxs("h2",{className:"text-xl font-semibold text-white mt-10 mb-4 flex items-center gap-2",children:[e.jsx(v,{className:"w-5 h-5 text-[#f1c40f]"}),"Tech Stack"]}),e.jsxs(E,{children:[e.jsx(o,{icon:j,title:"React 18 + TypeScript",description:"Modern frontend with hooks, suspense, and full type safety",color:"#61dafb"}),e.jsx(o,{icon:v,title:"Vite",description:"Lightning-fast HMR and optimized production builds",color:"#646cff"}),e.jsx(o,{icon:S,title:"Express.js",description:"Robust REST API with middleware architecture",color:"#68a063"}),e.jsx(o,{icon:b,title:"Turso (LibSQL)",description:"Edge-ready SQLite with global replication",color:"#00e5ff"}),e.jsx(o,{icon:N,title:"LangGraph",description:"Stateful AI pipelines with retry logic and validation",color:"#a371f7"}),e.jsx(o,{icon:w,title:"Tailwind CSS",description:"Utility-first styling with custom dark theme",color:"#38bdf8"})]}),e.jsx(l,{}),e.jsxs("h2",{className:"text-xl font-semibold text-white mb-4 flex items-center gap-2",children:[e.jsx(D,{className:"w-5 h-5 text-[#3fb950]"}),"Design Principles"]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx(x,{type:"tip",title:"Single Responsibility",children:"Each module handles one concern. AI graphs are separate from UI components, and database operations are isolated in their own layer."}),e.jsx(x,{type:"info",title:"Composable Pipelines",children:"LangGraph nodes can be reused across different workflows. The same validation node works for blogs, questions, and social posts."}),e.jsx(x,{type:"success",title:"Type Safety",children:"Full TypeScript coverage with strict mode. Zod schemas validate API inputs, and Drizzle ORM provides type-safe database queries."})]}),e.jsx(l,{}),e.jsx("h2",{className:"text-xl font-semibold text-white mb-4",children:"Project Structure"}),e.jsx(r,{title:"Directory Layout",language:"bash",code:`├── client/                 # React frontend
│   ├── src/
...
└── shared/                 # Shared types`})]})}function J(){return e.jsxs("div",{children:[e.jsx(h,{icon:N,title:"AI Pipeline (LangGraph)",description:"Stateful AI workflows with automatic retry, validation gates, and quality scoring. Built on LangGraph for reliable, observable AI operations.",color:"#a371f7"}),e.jsx(x,{type:"tip",title:"Why LangGraph?",children:"LangGraph provides stateful, graph-based workflows that are easier to debug, test, and extend than simple prompt chains. Each node can be retried independently, and the state is fully observable."}),e.jsx(d,{title:"Blog Generation Pipeline",description:"Multi-step workflow for generating blog posts with real-world case studies",diagram:`
graph LR
    A([Start]) --> B[Find Case]
    B --> C{Valid URL?}
    C -->|Yes| D{Score >= 6?}
...
`}),e.jsx(l,{}),e.jsx("h2",{className:"text-xl font-semibold text-white mb-4",children:"Usage Examples"}),e.jsx(r,{title:"Vector DB Service",language:"typescript",code:`import vectorDB from './services/vector-db.js';
...
`}),e.jsx("h2",{className:"text-xl font-semibold text-white mt-10 mb-4",children:"Component Categories"}),e.jsxs(E,{children:[e.jsx(o,{icon:y,title:"Layout Components",description:"Header, Sidebar, Footer - structural components that define page layout",color:"#58a6ff"}),e.jsx(o,{icon:j,title:"Core Components",description:"QuestionPanel, AnswerPanel, Mermaid - main feature components",color:"#a371f7"}),e.jsx(o,{icon:q,title:"UI Primitives",description:"Button, Card, Badge, Modal - reusable building blocks",color:"#f1c40f"}),e.jsx(o,{icon:v,title:"Custom Hooks",description:"useQuestion, useProgress, useAchievements - shared logic",color:"#3fb950"}),e.jsx(o,{icon:b,title:"Context Providers",description:"Theme, User Preferences, Credits - global state",color:"#f78166"}),e.jsx(o,{icon:D,title:"Error Boundaries",description:"Graceful error handling with fallback UI",color:"#da3633"})]}),e.jsx(l,{}),e.jsx("h2",{className:"text-xl font-semibold text-white mb-4",children:"Custom Hook Pattern"}),e.jsx(r,{title:"useQuestion Hook",language:"typescript",code:`import { useState, useEffect } from 'react';
...
export const useAchievements = () => {
  ...
  return ctx;
};`}),e.jsx(l,{}),e.jsx("h2",{className:"text-xl font-semibold text-white mb-4",children:"Styling Approach"}),e.jsx(x,{type:"info",title:"Tailwind + CSS Variables",children:"We use Tailwind for utility classes combined with CSS custom properties for theming. This allows easy theme switching while maintaining Tailwind's productivity benefits."}),e.jsx(r,{title:"Theme Variables",language:"css",code:`:root {
  --bg: #0d1117;
  --bg-secondary: #161b22;
  --bg-elevated: #21262d;
  --text: #f0f6fc;
...
`,i=[{method:"GET",path:"/data/channels.json",desc:"All channels with question counts"},{method:"GET",path:"/data/{channelId}.json",desc:"Questions, subchannels, companies per channel"},{method:"GET",path:"/data/coding-challenges.json",desc:"All coding challenges"},{method:"GET",path:"/data/certifications.json",desc:"All certifications"},{method:"GET",path:"/data/learning-paths.json",desc:"All learning paths"},{method:"GET",path:"/data/flashcards.json",desc:"All flashcards"},{method:"GET",path:"/data/blog-posts.json",desc:"Blog post index"},{method:"GET",path:"/blog-data.json",desc:"Full blog content"}];return e.jsxs("div",{children:[e.jsx(h,{icon:S,title:"Data Sources",description:"The app is a fully static SPA — all data is served from pre-built JSON files. No backend server required.",color:"#39c5cf"}),e.jsx(d,{title:"Data Flow",description:"All data flows directly from static JSON files — no backend server involved",diagram:s}),e.jsx("h2",{className:"text-xl font-semibold text-white mt-10 mb-4",children:"Data Files"}),e.jsx("div",{className:"rounded-xl border border-[#30363d] overflow-hidden",children:e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"w-full text-sm",children:[e.jsx("thead",{className:"bg-[#161b22]",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-4 py-3 text-left font-medium text-[#8b949e]",children:"Path"}),e.jsx("th",{className:"px-4 py-3 text-left font-medium text-[#8b949e] hidden md:table-cell",children:"Description"})]})}),e.jsx("tbody",{className:"divide-y divide-[#21262d]",children:i.map((t,a)=>e.jsxs("tr",{className:"hover:bg-[#161b22]/50",children:[e.jsx("td",{className:"px-4 py-3 font-mono text-[#e6edf3]",children:t.path}),e.jsx("td",{className:"px-4 py-3 text-[#8b949e] hidden md:table-cell",children:t.desc})]},a))})]})})}),e.jsx(l,{}),e.jsx("h2",{className:"text-xl font-semibold text-white mb-4",children:"Data Example"}),e.jsx(r,{title:"Channel JSON Structure",language:"json",code:`{
  "id": "system-design",
...
# Open http://localhost:5000`,copyable:!0})]})]}),e.jsx(l,{}),e.jsx("h2",{className:"text-xl font-semibold text-white mb-4",children:"Available Scripts"}),e.jsx(r,{title:"package.json scripts",language:"json",code:`{
  "scripts": {
    "dev": "vite",
    "build": "vite build",
...
}`}),e.jsx(x,{type:"warning",title:"Production Checklist",children:"Before deploying to production, ensure you have: configured all required environment variables, run database migrations, set up Qdrant collection with proper indexes, and tested the AI pipeline with your API keys."})]})}export{je as default};
