import{r as i,j as e,k as q,ag as X,bh as Q,ac as J,S as _,G as V,p,C as Z,E as Y,L as ee,Z as te,a4 as re,e as se,a8 as B,ad as ae}from"./index-DXbx92D8.js";import{InteractiveDiagram as ie}from"./InteractiveDiagram-D-4V_VJL.js";import{S as oe}from"./SEOHead-70v5GTLQ.js";import{C as U}from"./chevron-down-HhawA_OF.js";import{W as le,S as ne}from"./wand-sparkles-DX-sNQc5.js";import{I as de}from"./image-DHJ1fdQ6.js";import{C as z}from"./copy-BRBL5sc2.js";import{D as K}from"./download-C3uNXll7.js";import{L as ce}from"./lock-1W0Xl2Gx.js";import{D as me}from"./database-DFmrNqbe.js";import{N as xe}from"./network-CtKW3W9f.js";import{G as fe}from"./git-merge-BuchE4zQ.js";import{T as pe}from"./terminal-B7uk-Wsn.js";import{E as be}from"./eye-CJIAIpH8.js";import{E as ue}from"./eye-off-C6AR0XWM.js";import{C as he}from"./check-Cw5l47OJ.js";import{P as ge}from"./play-DrVz-xts.js";import{P as ve}from"./panels-top-left-N5WEMsg5.js";import"./zoom-out-ChWZLxYM.js";import"./rotate-ccw-DJUBBVIu.js";const je="https://image.pollinations.ai/prompt";function we(r,a){const s=encodeURIComponent(r),b=new URLSearchParams({width:String(a.width),height:String(a.height),model:a.model,seed:String(a.seed),nologo:"true",enhance:a.enhance?"true":"false"});return`${je}/${s}?${b}`}function ye(r,a){const[s,b]=i.useState(r);return i.useEffect(()=>{const n=setTimeout(()=>b(r),a);return()=>clearTimeout(n)},[r,a]),s}const g={keyword:"#ff7b72",control:"#ffa657",special:"#d2a8ff",arrow:"#79c0ff",bracket:"#3fb950",curly:"#ffa657",string:"#a5d6ff",comment:"#6e7681",number:"#f9a825"};function Ne(r){return r.split(`
`).map(a=>Se(a)).join(`
